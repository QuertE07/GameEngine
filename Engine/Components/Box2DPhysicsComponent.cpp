...
namespace gl
{
	...
	{
		GetOwner()->SetPosition(m_physicsBody->GetPosition());
		GetOwner()->SetRotation(m_physicsBody->GetRotation() * RadToDeg);
	}
	...
	void Box2DPhysicsComponent::SetRotation(const float rotation)
	{
